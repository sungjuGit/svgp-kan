...
## Citation
If you use this code or any modified versions of it (or perhas get some inspiration from our work), please cite our arXiv manuscript: Y. S. Ju (2025). Scalable and Interpretable Scientific Discovery via Sparse Variational Gaussian Process Kolmogorov-Arnold Networks.
